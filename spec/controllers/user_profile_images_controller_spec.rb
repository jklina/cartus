...
RSpec.describe UserProfileImagesController, type: :controller do
  describe "POST #create" do
    it "creates an image via xhr" do
      ...
      expect(image_json.fetch("imageable_id")).to eq(user.id)
  ...
  describe "DELETE #destroy" do
    it "destroys an image via xhr" do
      ...
      image = user.images.create!(image: blob.signed_id, imageable: user)
